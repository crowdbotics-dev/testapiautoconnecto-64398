...
## Project Structure
    ...
    ├── testapiautoconnecto_64398  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_64398`
...
2. Clone this repo and `cd testapiautoconnecto_64398`
